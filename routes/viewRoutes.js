...
router.get('/bills', authController.protect, viewsController.getBillsOverview);
...
router.get('/stats', authController.protect, viewsController.createStats, viewsController.getStats);
